...
(function syncTopInstrumentsPageMeta() {
    function run() {
        if (!window.i18n || !document.querySelector('.asset-info-page')) {
            return;
        }
        var t = window.i18n.t;
        var pt = t('topInstrumentsPage.meta.pageTitle');
        if (pt && pt !== 'topInstrumentsPage.meta.pageTitle') {
            document.title = pt;
        }
        var pd = t('topInstrumentsPage.meta.pageDescription');
        if (pd && pd !== 'topInstrumentsPage.meta.pageDescription') {
