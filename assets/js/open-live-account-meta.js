(function syncOpenLiveAccountPageMeta() {
    function run() {
        if (!window.i18n || !document.getElementById('openLiveAccountPageForm')) {
            return;
        }
        var t = window.i18n.t;
        var pt = t('openLiveAccountPage.meta.pageTitle');
        if (pt && pt !== 'openLiveAccountPage.meta.pageTitle') {
            document.title = pt;
        }
        var pd = t('openLiveAccountPage.meta.pageDescription');
        if (pd && pd !== 'openLiveAccountPage.meta.pageDescription') {
