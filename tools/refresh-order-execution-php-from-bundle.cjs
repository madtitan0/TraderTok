"use strict";
/**
 * Rebuilds includes/order-execution-policy.php from
 * tools/i18n-overrides/bundles/orderExecutionPolicy.bodies.en.json
 * Usage: node tools/refresh-order-execution-php-from-bundle.cjs
 */
const fs = require("fs");
...
const blockKeys = Object.keys(bodies)
  ...
  .sort(
    (a, b) =>
      parseInt(a.replace("block", ""), 10) - parseInt(b.replace("block", ""), 10)
  );
  ...
  <div class="container">
    <div class="page-hero-content legal-document-content" style="justify-content: start; align-items: flex-start; text-align: left;">
      <div class="doc-page-hero-title">
        <span data-i18n="orderExecutionPolicyPage.heroTitle" style='color: var(--brand-color-start)'>${
          bodies.heroTitle || "ORDER EXECUTION POLICY"
        }</span>
      </div>
`;
