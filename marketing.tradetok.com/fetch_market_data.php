...
$cacheFile = __DIR__ . '/market_data.json';
$symbols   = ['EURUSD','BTCUSD','ETHUSD','XAUUSD','US500','GBPJPY','WTI','XAGUSD','NFLX','NAS100','AUDUSD','GBPUSD','GOOGL','AAPL','TSLA'];
...
if (!empty($data)) {
    // Write new last_updated timestamp so browser knows exactly when this ran
    $payload = [
        'last_updated'    => time(),
...
// API failed — return existing JSON so page doesn't break
