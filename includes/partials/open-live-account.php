        ...
        <div class="container" style="padding-top: 100px;">
            <div class="registration-account-layout">
                <div class="registration-account-intro">
                    ...
                    <p class="section-body" data-i18n="openLiveAccountPage.beforeBody">Live accounts involve real capital and regulatory checks. Completing this form registers your interest so our team can guide you through verification and platform access.</p>
                    ...
                    <p class="registration-account-crosslink-wrap">
                        <a href="<?php echo htmlspecialchars(routeUrl('open-demo-account')); ?>" class="registration-account-crosslink" data-i18n="openLiveAccountPage.demoCrosslink">Open a demo account</a>
                    </p>
                    <p class="edu-lead-gate-note" data-i18n="openLiveAccountPage.formNote">This form is not yet connected to a live onboarding system. Submissions are simulated until you connect your CRM or registration API.</p>
                </div>
                <div class="registration-account-card">
                    ...
                    <form class="deposit-form registration-account-form" id="openLiveAccountPageForm" novalidate>
                        <div class="form-group">
                            ...
                            <input id="openLiveName" type="text" name="name" data-i18n-placeholder="openLiveAccountPage.placeholderFullName" placeholder="Your full name" required autocomplete="name">
                        </div>
                        <div class="form-group">
                            <label for="openLiveEmail" data-i18n="openLiveAccountPage.labelEmail">Email address</label>
                            <input id="openLiveEmail" type="email" name="email" data-i18n-placeholder="openLiveAccountPage.placeholderEmail" placeholder="you@example.com" required autocomplete="email">
                        </div>
                        <div class="form-group">
                            <label for="openLivePhone" data-i18n="openLiveAccountPage.labelPhone">Phone</label>
                            <input id="openLivePhone" type="tel" name="phone" data-i18n-placeholder="openLiveAccountPage.placeholderPhone" placeholder="Include country code" required autocomplete="tel">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="edu-lead-gate-consent">
                            <label class="edu-lead-gate-check-label">
                                ...
                                <span data-i18n-html="openLiveAccountPage.consentHtml">I understand that trading carries risk and I agree to be contacted about opening a live account. I have read the <a href="./privacy-policy" target="_blank" rel="noopener noreferrer">Privacy Policy</a>.</span>
                            </label>
                        </div>
                        <p class="edu-lead-gate-error" id="openLivePageError" role="alert" hidden></p>
                        <button type="submit" class="btn-primary registration-account-submit" data-i18n="openLiveAccountPage.submitButton">Submit live account request</button>
                    </form>
                </div>
            </div>
        </div>
