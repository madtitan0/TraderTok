        ...
        <div class="container" style="padding-top: 100px;">
            <div class="registration-account-layout">
                <div class="registration-account-intro">
                    <h1 class="education-subpage-section-title" data-i18n="openDemoAccountPage.heroTitle">Open a free demo account</h1>
                    ...
                    <p class="section-body" data-i18n="openDemoAccountPage.whyBody">A demo account lets you explore the platform, charts, and order types in a risk-free environment while you learn how markets move.</p>
                    ...
                    <p class="registration-account-crosslink-wrap">
                        <a href="<?php echo htmlspecialchars(routeUrl('open-live-account')); ?>" class="registration-account-crosslink" data-i18n="openDemoAccountPage.liveCrosslink">Open a live account</a>
                    </p>
                    <p class="edu-lead-gate-note" data-i18n="openDemoAccountPage.formNote">This form is not yet connected to a live CRM. Submissions are simulated until you wire your registration API.</p>
                </div>
                <div class="registration-account-card">
                    ...
                    <form class="deposit-form registration-account-form" id="openDemoAccountPageForm" novalidate>
                        <div class="form-group">
                            ...
                            <input id="openDemoName" type="text" name="name" data-i18n-placeholder="openDemoAccountPage.placeholderFullName" placeholder="Your full name" required autocomplete="name">
                        </div>
                        <div class="form-group">
                            <label for="openDemoEmail" data-i18n="openDemoAccountPage.labelEmail">Email address</label>
                            <input id="openDemoEmail" type="email" name="email" data-i18n-placeholder="openDemoAccountPage.placeholderEmail" placeholder="you@example.com" required autocomplete="email">
                        </div>
                        <div class="form-group">
                            <label for="openDemoPhone" data-i18n="openDemoAccountPage.labelPhone">Phone</label>
                            <input id="openDemoPhone" type="tel" name="phone" data-i18n-placeholder="openDemoAccountPage.placeholderPhone" placeholder="Include country code" required autocomplete="tel">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="submit" class="btn-primary registration-account-submit" data-i18n="openDemoAccountPage.submitButton">Submit demo request</button>
                    </form>
                </div>
            </div>
        </div>
